[Home](./index) &gt; [eth-connect](./eth-connect.md) &gt; [RequestManager](./eth-connect.requestmanager.md) &gt; [personal\_unlockAccount](./eth-connect.requestmanager.personal_unlockaccount.md)
